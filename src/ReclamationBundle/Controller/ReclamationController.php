...
class ReclamationController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('front_client_show', array('id' => $reclamation->getId()));
        }
    ...
    public function editAction(Request $request, Reclamation $reclamation)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('front_client_edit', array('id' => $reclamation->getId()));
        }
    ...
    public function deleteAction(Request $request, Reclamation $reclamation)
    {
        ...
        return $this->redirectToRoute('front_client_index');
    }
    ...
    private function createDeleteForm(Reclamation $reclamation)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('front_client_delete', array('id' => $reclamation->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
