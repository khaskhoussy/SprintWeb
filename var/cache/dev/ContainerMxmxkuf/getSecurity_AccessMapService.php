...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/front/'), [0 => 'ROLE_CLIENT'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/back/expert/'), [0 => 'ROLE_EXPERT'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/back/admin/'), [0 => 'ROLE_ADMIN'], NULL);
