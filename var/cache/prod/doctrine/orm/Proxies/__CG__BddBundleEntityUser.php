 ...
 */
class User extends \BddBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'BddBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'BddBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'BddBundle\\Entity\\User' . "\0" . 'telephone', '' . "\0" . 'BddBundle\\Entity\\User' . "\0" . 'image', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
